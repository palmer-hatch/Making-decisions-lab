...
/*
  Using an if statement and a comparison operator, create code that will check if Amy or Brittani is older,
   and then console.log '{name} is older'. Hint: Consider what will happen if 
   they are the same age. Handle this situation.
*/

// if (amysAge > brittanisAge){
//   console.log("Amy is older");
// } else if (brittanisAge > amysAge){
//   console.log("Britain is older");
//  } else { console.log("they be the same")
// };
...
/*
  ...
  were born in the same year. If they were, console.log 'Amy & Brittani were born in 
  the same year'. If they were not, console.log 'Amy & Brittani were not born in the same year'
*/

// if(amysBirthYear === brittanisBirthYear) {
//   console.log("They were born in the same year")
// } else { console.log ("they were not born in the same year")
// };
...
/*
  Using an if statement and a comparison operator, create code that will log a 
  suggestion on what type of clothes one should wear for the day, based on the above temperature and rain.
...
//   console.log("wear a shirt and bring an umbrella");
...
/*
  Create a for-loop that runs 10 times, logging the numbers 1 through 10. Ex, on the 
  first iteration it would log 1, on the second iteration it would log 2.
*/
...
// Within the while loop, log a countdown from the value of z to 1. Once you have 
// logged the countdown, make sure you decrement z by 1. If your code is running properly, 
